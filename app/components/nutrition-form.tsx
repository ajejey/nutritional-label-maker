...
servingsPerContainer: z.union([
  ...
  polyunsaturatedFat: z.number().min(0),
  monounsaturatedFat: z.number().min(0),
...
const formFields: Record<string, FormField[]> = {
  ...
  mainNutrients: [
    ...
    { name: "polyunsaturatedFat", label: "Polyunsaturated Fat (g)" },
    { name: "monounsaturatedFat", label: "Monounsaturated Fat (g)" },
